...
class CoordinatesControllerTest < ActionController::TestCase
  ...
  test "should create coordinate" do
    assert_difference('Coordinate.count') do
      post :create, coordinate: { latitude: @coordinate.latitude, longitude: @coordinate.longitude, route_id: @coordinate.route_id, sequential_id: @coordinate.sequential_id }
    end
  ...
  test "should update coordinate" do
    put :update, id: @coordinate, coordinate: { latitude: @coordinate.latitude, longitude: @coordinate.longitude, route_id: @coordinate.route_id, sequential_id: @coordinate.sequential_id }
    assert_redirected_to coordinate_path(assigns(:coordinate))
  end
